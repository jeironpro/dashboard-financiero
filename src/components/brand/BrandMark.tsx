...
/**
 * El «character moment» de la marca: 4 trazos + diagonal que se dibujan solos
 * al montar usando el trazo SVG de anime.js.
 */
export function BrandMark({ className, strokeClassName = 'stroke-pear-deep' }: BrandMarkProps) {
  ...
  return (
    <svg
      ...
      fill="none"
    >
      <g strokeWidth={5} strokeLinecap="round" className={strokeClassName}>
